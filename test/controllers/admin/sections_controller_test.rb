...
class Admin::SectionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create admin_section" do
    assert_difference('Admin::Section.count') do
      post admin_sections_url, params: { admin_section: { description: @admin_section.description, location: @admin_section.location, title: @admin_section.title, url: @admin_section.url } }
    end
  ...
  test "should update admin_section" do
    patch admin_section_url(@admin_section), params: { admin_section: { description: @admin_section.description, location: @admin_section.location, title: @admin_section.title, url: @admin_section.url } }
