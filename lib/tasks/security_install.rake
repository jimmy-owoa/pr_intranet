namespace :security do
  task install: :environment do
    ...
    General::User.create(name: 'Nombre test', last_name: 'Apellido test', birthday: Date.today, email: 'test1@test.com', password: 'exaConsultores', password_confirmation: 'exaConsultores', location_id: 2, legal_number: "1", legal_number_verification: "7", date_entry: Date.today)
    General::User.create(name: 'Test', last_name: 'test', birthday: Date.today, email: 'test@test.com', password: 'exaConsultores', password_confirmation: 'exaConsultores', location_id: 2, legal_number: "16207227", legal_number_verification: "7", date_entry: Date.today)
