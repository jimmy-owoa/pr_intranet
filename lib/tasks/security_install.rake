namespace :security do
  task install: :environment do
    ...
    General::User.create(id: 3, name: 'Test', last_name: 'test', birthday: Date.today, email: 'test@test.com', password: 'exaConsultores', password_confirmation: 'exaConsultores', location_id: 2, legal_number: "16207227", legal_number_verification: "7", date_entry: Date.today)
    ...
    General::Section.find_or_create_by(id: 1, title: 'Conoce mi área', description: 'Esta es la descripción de la sección', position: 1, url: 'url-blablabla-1')
    General::Section.find_or_create_by(id: 3, title: 'Avisos clasificados', description: 'Esta es la descripción de la sección/', position: 3, url: 'url-blablabla-3')
    General::Section.find_or_create_by(id: 4, title: 'Grupo security', description: 'Esta es la descripción de la sección/', position: 4, url: 'url-blablabla-4')
    General::Section.find_or_create_by(id: 5, title: 'Concursos internos', description: 'Esta es la descripción de la sección', position: 5, url: 'url-blablabla-5')
    General::Section.find_or_create_by(id: 6, title: 'Cultura security', description: 'Esta es la descripción de la sección', position: 6, url: 'url-blablabla-6')
