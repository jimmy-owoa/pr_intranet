module Admin
  class SearchController < AdminController
    def search
      ...
      if search
        result = Searchkick.search search, index_name: [General::User, News::Post, General::Menu, General::Benefit, General::Gallery, Survey::Survey], match: :word
        ...
        @galleries = result.with_hit.map { |a| a[0] if a[1]["_index"].include?("general_galleries") }.compact.paginate(:page => params[:page], :per_page => 18)
