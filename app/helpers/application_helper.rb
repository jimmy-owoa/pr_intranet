module ApplicationHelper
  ...
  def fix_content(content)
    ...
    if Rails.env.development?
      ...
      content = content.gsub("<source src=\"../..", '<video src="https://miapp.security.cl')
      content = content.gsub("<source src=\"", '<video src="https://miapp.security.cl/')
      content = content.gsub("<img src=\"../..", '<img src="https://miapp.security.cl')
      content = content.gsub("<img src=\"/rails/", '<img src="https://miapp.security.cl/rails/')
      content = content.gsub("<a href=\"//rails/", '<a href="https://miapp.security.cl/rails/')
      content = content.gsub("<a href=\"/rails/", '<a href="https://miapp.security.cl/rails/')
      ...
      #image
      if content.include?("<p><img style=\"display: block; margin-left: auto; margin-right: auto;\"")
        content = content.gsub("<p><img style=\"display: block; margin-left: auto; margin-right: auto;\" src=\"/rails/", '<p><img style="display: block; margin-left: auto; margin-right: auto;" src="https://miapp.security.cl/rails/')
      end
      if content.include?("<p><img style=\"float: right;\"")
        content = content.gsub("<p><img style=\"float: right;\" src=\"/rails/", '<p align="right"><img src="https://miapp.security.cl/rails/')
      end
      if content.include?("<p><img style=\"float: left;\"")
        content = content.gsub("<p><img style=\"float: left;\" src=\"/rails/", '<p align="left"><img src="https://miapp.security.cl/rails/')
      end
      if content.include?("<p style=\"text-align: center;\"><img style=\"float: left;\"")
        content = content.gsub("<p style=\"text-align: center;\"><img style=\"float: left;\" src=\"/rails/", '<p style="text-align: center;"><img style="float: left;" src="https://miapp.security.cl/rails/')
      end
    end
